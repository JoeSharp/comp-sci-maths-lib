...
const TEST_CASES: TestCase[] = [
    ...
    { a: binaryToBoolArray('0000000000000001'), b: binaryToBoolArray('0000000000000001'), expected: binaryToBoolArray('0000000000000010') },
]
...
describe('Add 16', () => {
    ...
    TEST_CASES.forEach(({ a, b, expected }) => {
        ...
        test(testName, () => {
            add16.sendToInputBus(PIN_A, a);
            add16.sendToInputBus(PIN_B, b);
